...
function Profile() {
    ...
    return (
        <Box>
            <Heading fontSize="3xl" fontWeight="bold" color="gray.400" textAlign="center" py="0" pt="10">My Projects</Heading>
            <Text fontSize="1xl" color="gray.600" textAlign="center">Some of the projects I have done.</Text>
            <Flex direction={isNotSmallerScreen ? "row":"column"} w="100%" maxWidth={{base:"100vh", md:"130vh", lg:"130vh", xl:"130vh"}}>
                {/* <Box alignSelf="center" pr="10" py="16">
                    <Heading fontWeight="extrabold" color="cyan.500" size="4xl">
                        7+
                    </Heading>
                    <Text fontSize="2xl" color="gray.400">Years of Experience</Text>
                </Box> */}
                <Box alignSelf="center" px="5" py="0">
